...
---
*Snapshot 2026-06-10 — 8.24.0 live su entrambi i servizi + custom domain (Replace-iT 2b-1.5: asse del seme 3-punti robusto via replaceEstimateCylinderAxis, indipendente dai click — fix "marker coricato" del collaudo 8.23.1; PENDING conferma utente sul re-test scan reale). Aggiornare al prossimo cambio di stato.*
