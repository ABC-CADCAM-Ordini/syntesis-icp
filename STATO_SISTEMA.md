...
---
*Snapshot 2026-06-10 — 8.23.1 live su entrambi i servizi + custom domain (Replace-iT FASE 2 — Passo 2b completo: seeding 3 punti robusto asse-da-scansione → Raffina/ICP per-marker, quinto workflow `replace`; + cleanup cosmetico blocco replace*). Aggiornare al prossimo cambio di stato.*
