...
## Versione live (2026-06-05, 8.12.0 — estrazione **panel/UI infra** /analizzare in modulo `ds/syn-panel.js` [2° modulo: pannelli drag/resize, view-state, rail, view-menu, tooltip; **relocazione in-place verbatim**, gate browser reale diff 0]. Base 8.11.0: clip engine in `ds/syn-clip.js`; r169 via `ds/syn-render.js`)

| Componente | Versione |
|---|---|
| Backend principale (b7671e12) | 8.12.0 (live, commit `4599fa3` del 2026-06-05, deploy `d782e8fa`) |
| Legacy syntesis-icp (7ac922ce) | 8.12.0 (live, commit `4599fa3` del 2026-06-05, deploy `3460aa19`) |
...
---
*Snapshot 2026-06-05 — 8.12.0 live su entrambi i servizi + custom domain (estrazione panel/UI infra /analizzare in modulo ds/syn-panel.js, 2° modulo della modularizzazione del monolite v3b; relocazione in-place verbatim, gate browser reale diff 0). Aggiornare al prossimo cambio di stato.*
