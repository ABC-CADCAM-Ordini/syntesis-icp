...
> **Versione software mappata:** 8.26.0 — **Data:** 2026-06-10
...
| Anteprima marker | `#replacePreviewBox` / `#replacePreviewCanvas` | mousedown (canvas) + window mousemove/mouseup (orbit/click) | `replacePreviewInit/Render/Dispose` → `replacePreviewPickAt` | secondo `THREE.WebGLRenderer`: orbita la mesh marker e raccoglie i 3 punti del seme (dot 1 rosso/2 verde/3 blu, frame locale via `worldToLocal`) | [1990](../backend/static/syntesis-analyzer-v3b.html#L1990)/[1992](../backend/static/syntesis-analyzer-v3b.html#L1992) markup; [15601](../backend/static/syntesis-analyzer-v3b.html#L15601)/[15646](../backend/static/syntesis-analyzer-v3b.html#L15646) |
