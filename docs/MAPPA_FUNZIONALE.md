...
| Dropdown libreria | `#replaceLibSelect` | change | `replaceOnLibChange` → `GET /api/rit/libraries/{id}` | popola type | [1980](../backend/static/syntesis-analyzer-v3b.html#L1980) / [15748](../backend/static/syntesis-analyzer-v3b.html#L15748) |
| Dropdown type | `#replaceTypeSelect` | change | `replaceOnTypeChange` | seleziona il type, azzera il seme (`replaceSeedClear`) e carica l'anteprima interattiva del marker (`replaceFetchMarkerGeo` → `replacePreviewInit`) | [1985](../backend/static/syntesis-analyzer-v3b.html#L1985) / [15775](../backend/static/syntesis-analyzer-v3b.html#L15775) |
