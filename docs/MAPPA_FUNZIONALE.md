...
> **Versione software mappata:** 8.34.0 — **Data:** 2026-06-10
...
| ▶ Allinea (ICP) | `#replaceBtnAlign` (finestra guida) | click | `replaceAutoPlaceFromSource` | **8.31.2**: UNICO trigger esplicito dell'auto-posa sorgente→sostituto (ICP full-surface + multi-start roll). Visibile a fase `chooseType` quando scanbody individuato + entrambi i type scelti (gating in `replaceSeedUpdateUI`). Sostituisce l'auto-partenza implicita al cambio menu (`replaceMaybeAutoPlace` ora solo refresh UI) → fix dead-end "② Marker". | [1487](../backend/static/syntesis-analyzer-v3b.html#L1487) markup; [15846](../backend/static/syntesis-analyzer-v3b.html#L15846) gating; [16351](../backend/static/syntesis-analyzer-v3b.html#L16351) handler |
